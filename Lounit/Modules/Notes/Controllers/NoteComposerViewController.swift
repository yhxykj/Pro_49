...
final class NoteComposerViewController: UIViewController {
    private static let publishCost = 10
    ...
    private func setupView() {
        ...
        costLabel.font = .systemFont(ofSize: 20, weight: .semibold)
    ...
    private func setupLayout() {
        ...
        NSLayoutConstraint.activate([
            ...
            noteTextView.topAnchor.constraint(equalTo: titleLabel.bottomAnchor, constant: 16),
            noteTextView.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 21),
            noteTextView.trailingAnchor.constraint(equalTo: contentView.trailingAnchor, constant: -21),
            ...
            addPhotoContainerView.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 21),
            ...
            costLabel.topAnchor.constraint(equalTo: addPhotoContainerView.bottomAnchor, constant: 58),
            costLabel.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 21),
            costLabel.trailingAnchor.constraint(equalTo: contentView.trailingAnchor, constant: -21),
    ...
    @objc private func didTapRelease() {
        ...
        guard GoldCoinStore.spendCoins(Self.publishCost) else {
            showInsufficientCoinsCard(requiredCoins: Self.publishCost, currentCoins: GoldCoinStore.balance)
            return
        }

        do {
            try LocalNotesStore.save(text: noteText, image: selectedPhoto)
        } catch {
            GoldCoinStore.addCoins(Self.publishCost)
            showAlert(message: "Failed to save note. Please try again.")
            return
        }
    ...
    private func showInsufficientCoinsCard(requiredCoins: Int, currentCoins: Int) {
        ...
        messageLabel.text = "Publishing this note costs \(requiredCoins) gold coins. Your current balance is \(currentCoins)."
...
extension NoteComposerViewController: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
...
extension NoteComposerViewController: UIGestureRecognizerDelegate {
