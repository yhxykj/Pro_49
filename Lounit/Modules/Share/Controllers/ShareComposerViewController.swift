//
//  ShareComposerViewController.swift
//  Lounit
//
...
final class ShareComposerViewController: UIViewController {
    ...
    private func setupView() {
        ...
        addPhotoContainerView.layer.cornerRadius = 12
    ...
    private func setupLayout() {
        ...
        NSLayoutConstraint.activate([
            ...
            introTextView.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 30),
            introTextView.trailingAnchor.constraint(equalTo: contentView.trailingAnchor, constant: -30),
            ...
            costLabel.topAnchor.constraint(equalTo: addPhotoContainerView.bottomAnchor, constant: 38),
...
extension ShareComposerViewController: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
...
extension ShareComposerViewController: UIGestureRecognizerDelegate {
