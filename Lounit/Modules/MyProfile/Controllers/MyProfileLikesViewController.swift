//
//  MyProfileLikesViewController.swift
//  Lounit
//
...
final class MyProfileLikesViewController: UIViewController {
    ...
    private func setupView() {
        ...
        tableView.register(
            MyProfileLikePostTableViewCell.self,
            forCellReuseIdentifier: MyProfileLikePostTableViewCell.reuseIdentifier
        )
    ...
    private func reloadLikedPosts() {
        posts = SharePostActionStore.likedPosts
        tableView.reloadData()
        emptyStateImageView.isHidden = !posts.isEmpty
    }
...
extension MyProfileLikesViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(
            withIdentifier: MyProfileLikePostTableViewCell.reuseIdentifier,
            for: indexPath
        ) as! MyProfileLikePostTableViewCell
        cell.configure(with: posts[indexPath.row])
        return cell
    }
}

extension MyProfileLikesViewController: UITableViewDelegate {
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        let viewController = ShareDetailViewController(post: posts[indexPath.row])
